...
RUN cd /workspace \
    ...
    && colcon build --symlink-install --cmake-args \ 
        -DCMAKE_CUDA_ARCHITECTURES="$(echo ${TARGET_CUDA_ARCH} | sed 's/\.//g')" \
